...
def ollama_chat():
    try:
        ...
        # Build prompt
        contact_info = f"""
        📞 Phone Number: +65 6294 8888
        📧 Email: info@koloristsg.com
        📍 Orchard Branch Address: 333 Orchard Road, #04-22, Singapore 238867
        """
...
When replying to the user's message, please format your response clearly using:
- Bullet points (•) for lists of details, add a spacing ( ) for each bullet point (•)
- Headings in **bold** for sections like **Contact Information**, **Haircut Prices**, etc.
- Keep answers concise, friendly, and structured.

Include the following salon contact details whenever relevant:
📞 Phone: +65 6294 8888  
📧 Email: info@koloristsg.com  
📍 Orchard Branch Address: 333 Orchard Road, #04-22, Singapore 238867  
